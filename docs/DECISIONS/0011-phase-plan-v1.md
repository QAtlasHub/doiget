...
Phase 0 = 5-7 days (specs + skeleton). Phase 1 = 1.5 weeks. Phase 2 = 1 week. Phase 3 = 1.5 weeks. MVP shipping point = 5 weeks. Phase 5 (TDM) is broken into 5a/5b/5c with cooldown, and the decision to start any of them is data-driven from Phase 0-4 production usage.
...
To revise this decision, write a new ADR with Status: Accepted and Supersedes: 0011,
