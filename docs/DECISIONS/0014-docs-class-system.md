...
Each doc declares Status: NORMATIVE or Status: INFORMATIVE. Changes to NORMATIVE content require a matching ADR. ADRs themselves live under docs/DECISIONS/ in Michael Nygard format. ADR INDEX.md lists every accepted ADR.
...
To revise this decision, write a new ADR with Status: Accepted and Supersedes: 0014,
